                      ...
                      <div className="space-y-10">
                         ...
                         <div className="grid grid-cols-1 gap-8">
                            <div className="space-y-3">
                               ...
                               <input name="origin" defaultValue={editingShipment?.origin} className="w-full bg-gray-50 rounded-2xl p-5 border border-gray-100 font-bold text-navy outline-none focus:border-primary/40 focus:ring-4 ring-primary/5 transition-all" required />
                            </div>
                            <div className="space-y-3">
