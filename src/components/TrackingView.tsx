...
import { Search, Package, Zap, ArrowRight as LucideArrowRight } from 'lucide-react';
...
export const TrackingView: React.FC<TrackingViewProps> = ({ onSearch, isSearching }) => {
  ...
  return (
    <div className="min-h-[60vh] pt-32 pb-20 bg-gray-50">
              ...
              <div className="flex items-center py-2 md:py-3">
                ...
                >
                  {isSearching ? (
                    ...
                    <>
                      Monitor <LucideArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </>
                  )}
                </button>
              </div>
